<div class="col-md-3 pad_rit_none">
    <div class="lft_nav_btn dashbrd_bg">
        ...
        <ul class="nav nav-tabs dashbrd_tab" role="tablist">
          ...
          <li <?php if($userMenuActive==5){?>class="active"<?php }?>><a href="<?php echo BASE_URL.'my-groups';?>">Groups <span><i class="fa  fa-group"></i></span></a></li>
          <?php if($userMenuActive==7){?>
          <li <?php if($userMenuActive==7){?>class="active"<?php }?>><a href="<?php echo BASE_URL.'my-groups-orders';?>">Groups Order<span><i class="fa fa-line-chart"></i></span></a></li>
          <?php }?>
          ...
          <li <?php if($userMenuActive==9){?>class="active"<?php }?>><a href="<?php echo BASE_URL.'my-notifications';?>">Notifications<span class="badge"><?=$tot_notfy?></span> <span class="pull-right"><i class="fa  fa-bell"></i></span></a></li>
        </ul>
    </div>
</div>