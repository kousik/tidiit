...
<table cellspacing=5 cellpadding=5 width=90% border=0 >
  ...
  <tr id="PageHeading">
      <td class="PageHeading bdr-none txt-center"><h3><span class="txtgrn txt28">Role Group Manager</span></h3></td>
  </tr>
  ...
  <tr>
    <td style="padding-left:50px;"><?php $js = 'id="AddBtn" onClick="ShowAddBox();" class="btn-add"';
echo form_button('AddBtn', 'Add Role Group', $js);?></td>
  </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr class="ListTestLable">
    ...
    <td>
        <a href="<?php echo base_url().'role/group_change_status/'.$InerArr->roleGroupId;?>" class="AdminDashBoardLinkText active-icon" onclick="if(!confirm('Are you Sure to do the action ?')){ return false;}"></a> &nbsp;
	...
	<a href="<?php echo base_url().'role/view_list/'.$InerArr->roleGroupId;?>" class="AdminDashBoardLinkText">Manage Role</a>
	</td> 
  </tr>
  <script language="javascript">
  ...
  <tr class="ListHeadingLable">
    <td colspan="5" style=" text-align: center;" height="35px;">No record found.</td>
  </tr>
  <?php } ?>
</table></td>
  </tr>
  ...
  <tr>
    <td><?php $attributes = array('name' => 'EditForm', 'id' => 'EditForm');echo form_open_multipart('role/edit_group/', $attributes);?>
...
<?php echo form_close();?></td>
  ...
  <tr>
    <td>
	<?php $attributes = array('name' => 'AddForm', 'id' => 'AddForm');echo form_open_multipart('role/add_group', $attributes);?>
