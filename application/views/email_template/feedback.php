                ...
                <tr>
                  ...
                  <td width="80%" align="left" valign="top"><br />
                    ...
                    <font style="font-family: Verdana, Geneva, sans-serif; color:#666766; font-size:13px; line-height:21px">
                     A new feedback has posted.Feedback details as bellow.
                    <br /><br />
					Name : <strong><?php echo $feedback['TEMPLATE_FEEDBACK_NAME'];?></strong><br />
					Email : <strong><?php echo $feedback['TEMPLATE_FEEDBACK_EMAIL'];?></strong><br />
					Phone : <strong><?php echo $feedback['TEMPLATE_FEEDBACK_PHONE'];?></strong><br />
					Message : <strong><?php echo $feedback['TEMPLATE_FEEDBACK_MSG'];?></strong><br />
					Posted Time : <strong><?php echo $feedback['TEMPLATE_FEEDBACK_TIME'];?></strong><br />
                    </font> <br /></td>
                  <td width="10%">&nbsp;</td>
                </tr>
