<div style="width:800px;">
    <div style="width:100%">
        ...
        <div style="width: 70%;text-align: left;float: left;"><h1>Your Password at Tidiit Inc Ltd</h1></div>
    </div>
    ...
    <div style="clear: both;width:100%;text-align: center;">
        <table style="text-align: center;">
            ...
            <tr><td>&nbsp;</td></tr>
            <tr>
                <td>Your Username : <?php echo $userDetails[0]->userName;?></td>
            </tr>
            <tr><td>&nbsp;</td></tr>
            <tr>
                <td>Your Password is : <?php echo base64_decode(current(explode('~', $userDetails[0]->password)));?></td>
            </tr>
        </table>
    </div>
    <div style="clear: both;width:100%; height: 40px"></div>
