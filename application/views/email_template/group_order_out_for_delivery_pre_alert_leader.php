            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="80%" align="left" valign="top"><font style="font-family: Georgia, 'Times New Roman', Times, serif; color:#010101; font-size:14px"><strong><em>Hi <?php echo $leaderFullName;?>,</em></strong></font><br />
					...
					Master order no is <a style="text-decoration:underline;" target="_blank" href="#"><span style="color:#565656;font-size:13px;">TIDIIT-OD-<?php echo $orderDetails[0]->parrentOrderID;?></span></a><br />This is a pre-alert before your item out for delivery. <br />
                    <br />
					...
					<?php if($isPaid==0){?><br />
					As <?php echo $buyerFullName?> had order order the item with <strong>Settle on Delivery</strong> Method,<br /> please be ready <?php echo $buyerFullName?> payment in his/her account.<br />
					You will get another notifiacation when item will out for delivery.<br />Make payment from <?php echo $buyerFullName?> my account so logistics people delivery your item in your door step.
					<?php }?>	</font> <br /></td>
                  <td width="10%">&nbsp;</td>
                </tr>
                <tr>
