            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="80%" align="left" valign="top">
					...
					Buyer Club Re-order [TIDIIT-OD<?php echo $group_order_decline['TEMPLATE_GROUP_ORDER_DECLINE_ORDER_ID'];?>] cancel by <strong><?php echo $group_order_decline['TEMPLATE_GROUP_ORDER_DECLINE_ADMIN_NAME'];?></strong>
                    </font> <br /><br /><br />
                   <font style="font-family: Verdana, Geneva, sans-serif; color:#666766; font-size:13px; line-height:21px">
				   Hi, <br /><br /> Sorry! I can not process this Buyer Club order right now.
				   </font>
