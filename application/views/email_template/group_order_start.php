                      ...
                      <tr>
                        <td height="46" align="right" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="29%" align="right"><font style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#68696a; font-size:8px"> <a href= "<?php echo $MainSiteBaseURL;?>" style="color:#68696a; text-decoration:none; text-transform:uppercase"><img src="<?php  echo $MainSiteImagesURL;?>android-ios.gif"  title="Download App" alt="" border="0" height="60"/></a> </td>
                              <td width="4%">&nbsp;</td>
                            </tr>
                          </table></td>
                      </tr>
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="80%" align="left" valign="top">
					...
					New Buyers Club order running by <strong><?php echo $group_order_start['TEMPLATE_GROUP_ORDER_START_TITLE'];?></strong>
                    </font> <br /><br /><br />
                   <font style="font-family: Verdana, Geneva, sans-serif; color:#666766; font-size:13px; line-height:21px">
				   Hi, <br /><br /> You have requested to buy Buyers Club order product. <br /><br />
				   Product is <a href='#'><?php echo $group_order_start['TEMPLATE_GROUP_ORDER_START_PRODUCT_TITLE'];?></a><br /><br />
				   <strong>Want to process the order ?</strong><br /><br />
				   <a href='<?php echo BASE_URL;?>shopping/group-order-decline/<?php echo base64_encode($group_order_start['TEMPLATE_GROUP_ORDER_START_ORDERID']*226201);?>'>Decline the Buyers Club Order</a><br /><br />
				   <a href='<?php echo BASE_URL;?>shopping/group-order-accept-process/<?php echo base64_encode($group_order_start['TEMPLATE_GROUP_ORDER_START_ORDERID']*226201);?>'>Accept the Buyers Club Order</a><br /><br />
				   </font>
