            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="80%" align="left" valign="top"><font style="font-family: Georgia, 'Times New Roman', Times, serif; color:#010101; font-size:14px"><strong><em>Hi <?php echo $userFullName;?>,</em></strong></font><br />
					...
					Contact number of delivery person : <?php echo $deliveryStaffContactNo;?>
					Email of delivery person : <?php echo $deliveryStaffEmail;?><br >
					<?php if($isPaid==0){?><br />
						<?php echo $buyerFullName;?> has posted the order by <strong>Settlement on delivery</strong> method.<br />Follow up the process before the order process for delviery.
					<?php }?><br />
					</font> <br />
					</p>
