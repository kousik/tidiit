...
class Api_Model extends CI_Model{
    ...
    function get_event(){
        ...
        $EventLogConfirmationText=$this->db->from('system_constants')->where('ConstantName','EventLogConfirmationText')->get()->result();
        foreach($Arr as $k){
            ...
            $k ->event_log_confirmation_text=$EventLogConfirmationText[0]->ConstantValue;
        }
        return $Arr;
    }
