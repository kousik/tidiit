...
var MagicZoom = (function(c) {
    ...
    a.zoom.prototype = {
        ...
        z18: function() {
            ...
            if (!this.z7) {
                this.z7 = new a.z47(this.c.firstChild);
                this.z1 = new a.z47(this.c.href)
            } else {
            ...
            if (!this.z46) {
                ...
                if (c.j21.trident4) {
                    ...
                    this.z46.z23 = this.z46.self.appendChild(j)
                }
                ...
                if ("undefined" !== typeof(h)) {
                    this.z46.g = $mjs(document.createElement("div")).j6({
                        ...
                        "line-height": "2em",
                        left: "0px"
                    }).changeContent(a.x7(h[0])).j32(this.z46.self, ((Math.floor(Math.random() * 101) + 1) % 2) ? "top" : "bottom")
                }
            }
        ...
        z20: function(h) {
            ...
            if (i && $mjs(i)) {
                ...
                $mjs(i).appendChild(this.z46.self)
            } else {
                if ("inner" == this.options.zoomPosition) {
            ...
            switch (this.options.zoomPosition) {
                case "right":
                    this.z46.self.style.left = f.right + this.options.zoomDistance + "px";
                    this.z46.adjustX.edge = "right";
                    break;
                case "left":
                    this.z46.self.style.left = f.left - this.options.zoomDistance - this.options.zoomWidth + "px";
                    break;
                case "top":
                    this.z46.z21 = f.top - (this.options.zoomDistance + this.options.zoomHeight) + "px";
                    break;
                case "bottom":
                    this.z46.z21 = f.bottom + this.options.zoomDistance + "px";
            ...
            if (c.j21.trident4 && this.z46.z23) {
                this.z46.z23.j6({
                    width: this.options.zoomWidth + "px",
                    height: this.options.zoomHeight + "px"
                })
            ...
            if (this.options.zoomPosition == "right" || this.options.zoomPosition == "left") {
                if (this.options.zoomAlign == "center") {
                    this.z46.z21 = (f.bottom - (f.bottom - f.top) / 2 - this.options.zoomHeight / 2) + "px";
                    this.z46.adjustY = {
                        edge: "bottom",
                        ratio: 2
                    }
                    ...
                    if (this.options.zoomAlign == "bottom") {
                        this.z46.z21 = (f.bottom - this.options.zoomHeight) + "px";
                        this.z46.adjustY.edge = "bottom"
                    } else {
                        this.z46.z21 = f.top + "px"
                    }
                }
            } else {
                if (this.options.zoomPosition == "top" || this.options.zoomPosition == "bottom") {
                    if (this.options.zoomAlign == "center") {
                        this.z46.self.style.left = (f.right - (f.right - f.left) / 2 - this.options.zoomWidth / 2) + "px";
                        this.z46.adjustX = {
                            edge: "right",
                            ratio: 2
                        }
                        ...
                        if (this.options.zoomAlign == "right") {
                            this.z46.self.style.left = (f.right - this.options.zoomWidth) + "px";
                            this.z46.adjustX.edge = "right"
                        } else {
                            this.z46.self.style.left = f.left + "px"
                        }
                    }
                }
            }
            ...
            if (this.options.alwaysShowZoom) {
                ...
                if (this.options.zoomFade) {
                    this.z2 = new c.FX(this.z46.self, {
        ...
        update: function(z, m, f, y) {
            var g, C, e, j, v, h, E = null,
                w = null,
                k = this.lastSelector,
                n, l, o, B, u, q, s, F, D, p;
            y = y || null;
            if (c.now() - this.z28 < 300 || this.z28 == -1 || this.ufx) {
                ...
                this.z35 = setTimeout(this.update.j24(this, z, m, f, y), g);
                return
            }
            if (y && this.lastSelector == y) {
                return
            } else {
                this.lastSelector = y
            }
            ...
            v = this.z7.height;
            this.stop(true);
            if (this.options.selectorsEffect != "false" && undefined !== m) {
                this.ufx = true;
                var A = $mjs(this.c.cloneNode(true)).j6({
                    position: "relative",
                    top: 0,
                    left: 0,
                    width: ""
                });
                var r = $mjs(this.c.parentNode).j5("width");
                var i = 0;
                if ("content-box" == $mjs(this.c.parentNode).j5("box-sizing")) {
                    i = (parseInt($mjs(this.c.parentNode).j5("padding-left")) || 0)
                }
                var x = c.$new("div", {
                ...
                if ("td" === this.c.parentNode.tagName.toLocaleLowerCase()) {
                    ...
                    this.c.parentNode.insertBefore(x, this.c)
                } else {
                    this.c.parentNode.parentNode.insertBefore(x, this.c.parentNode)
                }
                x.append(A);
                c.j21.webkit && x.j7();
                if (c.j21.ieMode && c.j21.ieMode < 8) {
                    $mjs(A.firstChild).j23(1)
                }
                h = new a.z47(A.firstChild);
                h.update(m);
                if ("pounce" == this.options.selectorsEffect) {
                    p = this.c.href;
                    l = this.selectors.filter(function(G) {
                        return G.href.has(p)
                    });
                    l = (l[0]) ? $mjs(l[0].byTag("img")[0] || l[0]) : this.z7.self;
                    o = this.selectors.filter(function(G) {
                        return G.href.has(z)
                    });
                    o = (o[0]) ? $mjs(o[0].byTag("img")[0] || o[0]) : null;
                    if (null == o) {
                        o = this.z7.self;
                        l = this.z7.self
                    }
                    u = this.z7.self.j8(), q = l.j8(), s = o.j8(), D = l.j7(), F = o.j7()
                }
                e = function(I) {
                    var G = {},
                        K = {},
                    ...
                    if (c.j21.ieMode && c.j21.ieMode < 8 && (j === h.width || 0 === h.width)) {
                    ...
                    if ("pounce" == this.options.selectorsEffect) {
                        ...
                        G.height = [v, D.height];
                        G.top = [u.top, q.top];
                        G.left = [u.left, q.left];
                        K.width = [F.width, h.width];
                        K.height = [F.height, h.height];
                        K.top = [s.top, u.top];
                        x.j6({
                            padding: ""
                        });
                        ...
                        K.left = [s.left, A.j8().left + parseInt(r) - i];
                        J.width = [j, h.width];
                        ...
                        L = $mjs(this.c.firstChild.cloneNode(false)).j32(c.body).j6({
                            position: "absolute",
                            "z-index": 5000,
                            left: G.left[0],
                            top: G.top[0],
                        ...
                        L = $mjs(this.c.firstChild.cloneNode(false)).j32(this.c).j6({
                            position: "absolute",
                            "z-index": 5000,
                            left: "0px",
                            top: "0px",
                        ...
                        if (j != h.width || v != h.height) {
                            J.width = K.width = G.width = [j, h.width];
                            J.height = K.height = G.height = [v, h.height]
                        }
                    ...
                    n.load($mjs(function() {
                        ...
                        new c.PFX([this.c, h.self, (L || this.c.firstChild)], {
        ...
        onresize: function(i) {
            ...
            this.z7.z13();
            if (this.z46.custom) {
                f = $mjs(this.z46.self.parentNode).j7();
                if (/%$/i.test(this.z46.initWidth)) {
                    this.options.zoomWidth = (parseInt(this.z46.initWidth) / 100) * f.width
                }
                if (/%$/i.test(this.z46.initHeight)) {
                    this.options.zoomHeight = (parseInt(this.z46.initHeight) / 100) * f.height
                }
            } else {
                if ("inner" === this.options.zoomPosition) {
                    this.options.zoomWidth = this.z7.width;
        ...
        pause: function() {
            ...
            if (!this.options.alwaysShowZoom && this.z4 && this.z4.z38) {
                ...
                if (this.z2) {
                    ...
                    var f = this.z46.self.j19("opacity");
                    this.z2.start({
                        opacity: [f, 0]
                    })
                } else {
    ...
    $mjs(document).je1("domready", function() {
        c.insertCSS(".mz-tmp-clone", "margin-right: 0 !important;margin-top: 0 !important;margin-bottom: 0 !important;padding-top: 0 !important;padding-bottom: 0 !important;border: 0 !important;position: relative  !important;height: 0 !important;min-height: 0 !important;z-index: -1;float: none !important;opacity: 0;", "mz-css");
