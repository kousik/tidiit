  ...
  options: {
    ...
    steps: {
      ...
      buildNavItems: function(i) {
		  if(i == 0){
			  return this.opts.steps.i18n.step +'General';
		  }else if(i == 1){
			return this.opts.steps.i18n.step +'Full Specification ';  
		  }else if(i == 2){
			return this.opts.steps.i18n.step +'Model Details';  
		  }else if(i == 3){
			return this.opts.steps.i18n.step +'Image';  
		  }else {
			return this.opts.steps.i18n.step +'Step '+(i+1);  
		  }
