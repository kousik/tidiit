<?php $orderInfo=$order_cancel['TEMPLATE_ORDER_CANCEL_ORDER_INFO'];?>
<div bgcolor="#8d8e90">
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="80%" align="left" valign="top"><font style="font-family: Georgia, 'Times New Roman', Times, serif; color:#010101; font-size:14px"><strong><em>Hi <?php echo $orderInfo['shipping']->firstName.' '.$orderInfo['shipping']->lastName;?>,</em></strong></font><br />
                    ...
                    <br />
					<?php echo $SellerName;?> has cancelled your order <a style="text-decoration:underline;" target="_blank" href="#"><span style="color:#565656;font-size:13px;">TIDIIT-OD-<?php echo $order_cancel['TEMPLATE_ORDER_CANCEL_ORDER_ID'];?></span></a>.<br /><br />
                    Order cancelation resson is as below.<br /> <strong><?php echo $cancelReason;?></strong></font> <br /></td>
                  <td width="10%">&nbsp;</td>
                </tr>
                <tr>
                      ...
                      <tbody>
                        <tr>
                          <td align="left" valign="top" style="background-color:#FFFFFF;display:block;clear:both;padding:20px 20px 0 20px;" bgcolor=""><table border="0" cellspacing="0" cellpadding="0" width="100%" style="">
                              <tbody>
                                <tr>
                                  <td colspan="4" width="100%" align="middle" valign="top"><p style="padding:0;color:#565656;line-height:22px;font-size:13px;">Please find below, the summary of your order <a style="text-decoration:underline;" target="_blank" href="#"><span style="color:#565656;font-size:13px;">TIDIIT-OD-<?php echo $order_cancel['TEMPLATE_ORDER_CANCEL_ORDER_ID'];?></span></a> </p>
                                    <br>
                                  </td>
                                </tr>
                                <?php /*<tr> 
