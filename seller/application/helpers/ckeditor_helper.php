...
function cke_create_instance($data = array()) {
    ...
    $return .= ',
  filebrowserBrowseUrl : "'.$data["judhipath"].'ckfinder/ckfinder.html",
    filebrowserImageBrowseUrl : "'.$data["judhipath"].'ckfinder/ckfinder.html?type=Images",
    filebrowserFlashBrowseUrl : "'.$data["judhipath"].'ckfinder/ckfinder.html?type=Flash",
    filebrowserUploadUrl : "'.$data["judhipath"].'ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files",
    filebrowserImageUploadUrl : "'.$data["judhipath"].'ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images",
    filebrowserFlashUploadUrl : "'.$data["judhipath"].'ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash",
